...
CSV_FIELD_ORDER = ['Lookup Hash', 'Rating',
'Comment',
# 'Positives',
'File Size',
'Virus',
...
CSV_FIELDS = {'Lookup Hash': 'hash',
            ...
            #   'Positives': 'positives',
              ...
              'Submitter City': 'telem_city',
              'Submitter Country': 'telem_country',
              'Submitter interface': 'telem_interface',
              'Submitter API Key': 'telem_source_key',
              'Submitter Name': 'telem_name',
              'File Type': 'filetype',
              'File Size': 'filesize',
              'MD5': 'md5',
              'SHA1': 'sha1',
